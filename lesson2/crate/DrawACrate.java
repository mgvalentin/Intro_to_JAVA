...
public class DrawACrate
{
    public static void main(String[] args)
    {
        ...
        face.draw();
        Line line1 = new Line(20,30,50,10); // top left line
        line1.draw();
        Line line2 = new Line(50,10,150,10); // top line
        line2.draw();
        Line line3 = new Line(150,10,150,50); // right most line
        line3.draw();
        Line line4 = new Line(150,50,120,70); //lower right line
        line4.draw();
        Line line5 = new Line(120,30,150,10); //top right line
        line5.draw();
